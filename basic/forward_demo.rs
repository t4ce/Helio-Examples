//! Forward opaque demo using helio v3.
//!
//! Controls:
...
use helio::{
    ...
    DebugDrawState, FlyCamera, FlyCameraConfig, LightId, PerspectiveLens, RenderMode, Renderer,
...
fn main() {
    env_logger::init();
    log::info!("Starting Helio Forward Opaque Demo");
            ...
            event_loop
                .create_window(
                    Window::default_attributes()
                        .with_title("Helio — Forward Opaque Demo")
