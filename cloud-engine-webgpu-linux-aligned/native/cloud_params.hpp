...
// native/trueos/cloud_simulation.clcpp::SimParams.
...
// native/trueos/cloud_render.clcpp::RenderParams.
...
// Browser/WebGPU workgroup dimensions. These are visual-reference details,
// not the native TRUEOS launch contract.
inline constexpr std::uint32_t kWebSimulationWorkgroupX = 4;
inline constexpr std::uint32_t kWebSimulationWorkgroupY = 4;
inline constexpr std::uint32_t kWebSimulationWorkgroupZ = 4;
inline constexpr std::uint32_t kWebRenderWorkgroupX = 8;
inline constexpr std::uint32_t kWebRenderWorkgroupY = 8;
